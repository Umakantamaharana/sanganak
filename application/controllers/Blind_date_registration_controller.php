...
class Blind_date_registration_controller extends CI_Controller {

	function __construct() {
        parent::__construct();
        $this->load->library('form_validation');
        $this->load->model('Blind_date_register_model');
    }
...
';
       ...
       // $data['user'] = $userData;
		$data['game'] = $pgame;
        //load the view
        $this->load->view('blind_date_registration_view', $data);
    }
     ...
     */
     public function email_check($str){
        ...
        $checkEmail = $this->Blind_date_register_model->getRows($con);
        if($checkEmail > 0){
	...
	public function transaction_no_check($str){
        ...
        $checkEmail = $this->Blind_date_register_model->getRow($con);
        if($checkEmail > 0){
