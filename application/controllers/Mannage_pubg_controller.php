...
class Mannage_pubg_controller extends CI_Controller {
...
public function __construct() {
    ...
    public function mannage(){
        ...
        if($this->session->userdata('isUserLoggedIn')){
			...
			$data['posts']=$this->Admin_model->pubg_getview();
		//print_r($posts);exit;
		
            $this->load->view('mannage_pubg_view', $data);
        }else{
	...
	public function active($id){
			...
			$data['posts']=$this->Admin_model->pubg_active($id);
	...
	//	$this->session->set_flashdata('Activated', '<script>alert("Your data was Activated successfully.");</script>');
        echo '<script>alert("Your data was Activated successfully.");</script>';		
			...
			$data['error_msg'] = 'Some problems occured, please try again.';
		   	...
		   	$url = 'Mannage_pubg_controller/mannage';
echo'
<script>
...
';
			...
			//return redirect('Mannage_pubg_controller/mannage');
	}
	...
	public function inactive($id){
			...
			$data['posts']=$this->Admin_model->pubg_inactive($id);
	...
	public function delete($id){
		...
		if($data['posts']=$this->Admin_model->pubg_delete($id)){
