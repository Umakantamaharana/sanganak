...
<div class="container admin-home">
    <h5>Paper Dance Event</h5>
<a href="<?php echo site_url('Event_list_controller/paper_dance_pdf'); ?>" target="new"><button>GENERATE PDF</button></a>
  ...
  <?php foreach($list as $list){ ?>
	...
	<td><?php echo $count;?></td>
      <td><?php echo $list['name']; ?>,&nbsp;&nbsp;
	   <?php echo $list['name2']; ?></td>
	   <td><?php echo $list['college_name']; ?></td>
      <td><?php echo $list['department']; ?></td>
	  <td><?php echo $list['phone']; ?></td>
      <td>
	<!--  <a href="<?php echo site_url('news/edit/'.$list['id']); ?>">Edit</a> -->
     <a href="<?php echo site_url('Event_list_controller/delete_paper_dance/'.$list['id']); ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
