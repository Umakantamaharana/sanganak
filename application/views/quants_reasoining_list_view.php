...
<div class="container admin-home">
    <h5>Quants & Reasoining Event</h5>
<a href="<?php echo site_url('Event_list_controller/quants_reasoining_pdf'); ?>" target="new"><button>GENERATE PDF</button></a>
<table class="table table-hover">
  ...
  <?php foreach($list as $list){ ?>
    ...
    <tr class="table-active">
     ...
     <a href="<?php echo site_url('Event_list_controller/delete_quants_reasoining/'.$list['id']); ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
