...
<div class="container admin-home">
    <h5>Drawing Event</h5>
<a href="<?php echo site_url('Event_list_controller/drawing_pdf'); ?>" target="new"><button>GENERATE PDF</button></a>
 ...
 $count = '1';
  ...
  <?php foreach($list as $list){ ?>
    ...
    <tr class="table-active">
     ...
     <a href="<?php echo site_url('Event_list_controller/delete_drawing/'.$list['id']); ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
    </tr>
