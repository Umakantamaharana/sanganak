...
<div class="container admin-home">
    <h5>Group discussion Event</h5>
<a href="<?php echo site_url('Event_list_controller/group_discussion_pdf'); ?>" target="new"><button>GENERATE PDF</button></a>
<table class="table table-hover">
  ...
  <?php foreach($list as $list){ ?>
	...
	<!--  <a href="<?php echo site_url('news/edit/'.$list['id']); ?>">Edit</a> -->
     <a href="<?php echo site_url('Event_list_controller/delete_group_discussion/'.$list['id']); ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
