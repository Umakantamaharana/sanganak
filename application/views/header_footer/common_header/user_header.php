...
<body>
    ...
    <!-- Navigation -->
	 <section class="cd-section" style="float: left; background:currentColor;">
    ...
    <div class="cd-bouncy-nav-modal">
      <nav>
        <ul class="cd-bouncy-nav">
          ...
          <li><a class="scroll" href="<?php echo site_url('user_account_controller/account');?>">USER PANEL</a></li>
