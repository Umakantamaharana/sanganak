...
<div class="container admin-home">
    <h5>Counter Strike Event</h5>
<a href="<?php echo site_url('Event_list_controller/counter_strike_pdf'); ?>" target="new"><button>GENERATE PDF</button></a>
<table class="table table-hover">
  ...
  <?php foreach($list as $list){ ?>
	...
	<!--  <a href="<?php echo site_url('news/edit/'.$list['id']); ?>">Edit</a> -->
     <a href="<?php echo site_url('Event_list_controller/delete_counter_strike/'.$list['id']); ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
