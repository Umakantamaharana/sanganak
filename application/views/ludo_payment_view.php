...
<div class="progressive-effects" id="skills" style="color:#FFF">
  <div class="container">
    ...
    <h3>You can pay Rs-10 any of the following options .</h3>
 ...
 <p class="footInfo text-center" style="color:#FFF">All ready Payment? <a class= "btn btn-primary" href="<?php echo site_url('Ludo_registration_controller/register'); ?>"style="color:#FF5733">Go For Registration.</a></p>
 </div>
			<br><br><br><br><br>
