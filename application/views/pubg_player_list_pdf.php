...
hr.vertical
{
	...
	<?php
						...
						<th width="15%" align="left" ><b>PLAYER 1</b></th> 	
                        <th width="15%" align="left" ><b>PLAYER 2</b></th> 	
                        <th width="15%" align="left" ><b>PLAYER 3</b></th> 	
                        <th width="15%" align="left" ><b>PLAYER 4</b></th> 
						...
						<td width="15%" align="left"><?php echo $r['name2']; ?></td> 
						<td width="15%" align="left"><?php echo $r['name3']; ?></td> 
						<td width="15%" align="left"><?php echo $r['name4']; ?></td> 
