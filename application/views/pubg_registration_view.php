...
<datalist id="department">
  ...
  <option>M-TECH</option>
			...
			<!--	 <p class="footInfo" style="color:#FFF">Already have Registered? <a href="<?php echo site_url('pubg_registration_controller/register_done'); ?>"style="color:red;"><button>Click here</button></a> -->
            </div>
			<br><br><br><br><br>
