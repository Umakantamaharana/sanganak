...
<div class="container admin-home">
    <h5>Paper Presentation Event</h5>
<a href="<?php echo site_url('Event_list_controller/paper_presentation_pdf'); ?>" target="new"><button>GENERATE PDF</button></a>
 ...
 $count = '1';
  ...
  <?php foreach($list as $list){ ?>
	...
	<td><?php echo $count;?></td>
     ...
     <a href="<?php echo site_url('Event_list_controller/delete_paper_presentation/'.$list['id']); ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
