...
<a href="<?php echo site_url('Event_list_controller/cultural_pdf'); ?>" target="new"><button>GENERATE PDF</button></a>
<table class="table table-hover">
  ...
  <?php foreach($list as $list){ ?>
	...
	<!--  <a href="<?php echo site_url('news/edit/'.$list['id']); ?>">Edit</a> -->
     <a href="<?php echo site_url('Event_list_controller/delete_cultural/'.$list['id']); ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
